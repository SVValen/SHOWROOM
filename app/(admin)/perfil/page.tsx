  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-lg mx-auto">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 mt-0.5">Cambiá tu nombre de usuario o contraseña</p>
      </div>

      <form onSubmit={guardar} className="space-y-6">
        {/* Datos de acceso */}
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5 space-y-4">
          <h2 className="text-sm font-semibold text-gray-700">Datos de acceso</h2>
          ...
          <div>
            <label className="block text-xs font-medium text-gray-500 mb-1.5">ID de Telegram (usuario)</label>
            <input
              type="text"
              value={telegramId}
              ...
              required
            />
            <p className="text-xs text-gray-400 mt-1">Este ID se usa para ingresar al panel y para acceder al bot</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5 space-y-4">
          ...
          <p className="text-xs text-gray-400 -mt-2">Dejá los campos vacíos si no querés cambiarla</p>
